...
> **Auto-generated from `stages/05-deployment-release/stage.yaml`**
>
...
| **Next Stage** | 6 |
| **Controls** | 7 required |
| **File** | [`stages/05-deployment-release/stage.yaml`](stages/05-deployment-release/stage.yaml) |
...
```mermaid
graph LR
  s5_1["Step 5.1: Release Readiness Checklist"]
  s5_2["Step 5.2: CAB Approval"]
  s5_3["Step 5.3: Rollback Plan Validation"]
  s5_4["Step 5.4: Infrastructure Security Baseline"]
  s5_4_secrets["Step 5.4-secrets: Secrets & Key Management Lifecycle"]
  s5_5["Step 5.5: Deployment Integrity Verification"]
  s5_6["Step 5.6: Deploy & Handover"]
  s5_1 --> s5_2
  s5_2 --> s5_3
  s5_2 --> s5_4
  s5_2 --> s5_4_secrets
