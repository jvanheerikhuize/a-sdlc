...
|------|------|---------------|------|------|
| [REQ](REQ.yaml) | Requester | 1 | — | [`roles/REQ.yaml`](REQ.yaml) |
...
| [LAD](LAD.yaml) | Lead Architect | 2 | — | [`roles/LAD.yaml`](LAD.yaml) |
| [DEV](DEV.yaml) | Developer | 3 | — | [`roles/DEV.yaml`](DEV.yaml) |
| [QA](QA.yaml) | QA Engineer | 4 | — | [`roles/QA.yaml`](QA.yaml) |
| [REL](REL.yaml) | Release Manager | 5 | — | [`roles/REL.yaml`](REL.yaml) |
| [OPS](OPS.yaml) | Operations / SRE | 5, 6 | — | [`roles/OPS.yaml`](OPS.yaml) |
