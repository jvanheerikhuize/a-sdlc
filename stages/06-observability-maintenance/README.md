...
| [RC-6B](../../controls/rc/RC-6B.yaml) | Third-Party Continuous Risk Monitoring *(conditional)* | Monitor critical ICT third-party provider risk: service availability, security advisories, breach notifications, SLA compliance. Alert on material risk changes. | Agent monitors, human reports | DORA: Art. 28(3); Art. 10–11 |
