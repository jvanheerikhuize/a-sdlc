...
> **Auto-generated from `stages/02-system-design/stage.yaml`**
>
...
| **Next Stage** | 3 |
| **Controls** | 8 required |
| **File** | [`stages/02-system-design/stage.yaml`](stages/02-system-design/stage.yaml) |
...
```mermaid
graph LR
  s2_1["Step 2.1: Draft System Design"]
  s2_2["Step 2.2: Design Validation"]
  s2_3["Step 2.3: STRIDE Threat Modelling"]
  s2_4["Step 2.4: AI Component Design Review"]
  s2_3b["Step 2.3b: Privacy Impact Assessment"]
  s2_3c["Step 2.3c: Zero-Trust Architecture Validation"]
  s2_5["Step 2.5: Design Approval"]
  s2_6["Step 2.6: AI Model Governance and Version Control"]
  s2_7["Step 2.7: Stage Directive Injection"]
  s2_1 --> s2_2
  s2_1 --> s2_3
  s2_1 --> s2_4
  s2_1 --> s2_3b
