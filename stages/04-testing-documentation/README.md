...
> **Auto-generated from `stages/04-testing-documentation/stage.yaml`**
>
...
| **Next Stage** | 5 |
| **Controls** | 9 required |
| **File** | [`stages/04-testing-documentation/stage.yaml`](stages/04-testing-documentation/stage.yaml) |
...
graph LR
  s4_1["Step 4.1: SAST"]
  s4_2["Step 4.2: Functional & Non-Functional Testing"]
  s4_3["Step 4.3: DAST"]
  s4_4["Step 4.4: AI Output Validation"]
  s4_5["Step 4.5: Bias & Fairness Testing"]
  s4_6["Step 4.6: Documentation Completeness"]
  s4_2_api["Step 4.2-api: API Security Testing"]
  s4_7_ai_adversarial["Step 4.7-ai-adversarial: Adversarial AI Robustness Testing"]
  s4_8["Step 4.8: Risk Threshold Evaluation"]
  s4_1 --> s4_2
  s4_1 --> s4_3
  s4_1 --> s4_4
  s4_1 --> s4_5
