...
> **Auto-generated from `stages/01-intent-ingestion/stage.yaml`**
>
...
| **Next Stage** | 2 |
| **Controls** | 8 required |
| **File** | [`stages/01-intent-ingestion/stage.yaml`](stages/01-intent-ingestion/stage.yaml) |
...
```mermaid
graph LR
  s1_1["Step 1.1: Screen Incoming Request"]
  s1_2["Step 1.2: Draft Feature Specification"]
  s1_3["Step 1.3: Conflict Analysis"]
  s1_4["Step 1.4: Risk Classification"]
  s1_5["Step 1.5: AI Tier Classification (conditional)"]
  s1_5b["Step 1.5b: Data Classification Screening"]
  s1_6["Step 1.6: Product Owner Sign-off"]
  s1_1 --> s1_2
  s1_2 --> s1_3
  s1_2 --> s1_4
  s1_2 --> s1_5
