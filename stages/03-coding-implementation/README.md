...
> **Auto-generated from `stages/03-coding-implementation/stage.yaml`**
>
...
| **Next Stage** | 4 |
| **Controls** | 9 required |
| **File** | [`stages/03-coding-implementation/stage.yaml`](stages/03-coding-implementation/stage.yaml) |
...
```mermaid
graph LR
  s3_1["Step 3.1: Verify Prerequisites & Load Permissions"]
  s3_2["Step 3.2: Implementation Loop"]
  s3_2_sc3c["Step 3.2-sc3c: Secrets Scanning"]
  s3_2_sc3d["Step 3.2-sc3d: Software Composition Analysis"]
  s3_2_sc3e["Step 3.2-sc3e: Container & IaC Security Scanning"]
  s3_2_rc3a["Step 3.2-rc3a: Decision Logging"]
  s3_2_gc3a["Step 3.2-gc3a: Agent Provenance Registry"]
  s3_3["Step 3.3: Agent Output Scan"]
  s3_4["Step 3.4: Pull Request Creation"]
  s3_1 --> s3_2
  s3_1 --> s3_2_sc3c
  s3_1 --> s3_2_sc3d
  s3_1 --> s3_2_sc3e
