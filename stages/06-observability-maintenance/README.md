...
> **Auto-generated from `stages/06-observability-maintenance/stage.yaml`**
>
...
| **Controls** | 6 required |
| **File** | [`stages/06-observability-maintenance/stage.yaml`](stages/06-observability-maintenance/stage.yaml) |
...
```mermaid
graph LR
  s6_1["Step 6.1: Activate Monitoring"]
  s6_2["Step 6.2: SLA/SLO Monitoring"]
  s6_3["Step 6.3: Risk & Health Monitoring"]
  s6_3_3rd_party["Step 6.3-3rd-party: Third-Party Risk Monitoring"]
  s6_4["Step 6.4: Incident Scanning & Detection"]
  s6_5["Step 6.5: Runtime Anomaly Detection"]
  s6_6["Step 6.6: AI Post-Market Surveillance"]
  s6_1 --> s6_2
  s6_1 --> s6_3
  s6_1 --> s6_3_3rd_party
  s6_1 --> s6_4
